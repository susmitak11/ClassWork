...
namespace ClassWorkDatabase
{
    public partial class Form1 : Form
        {
            private string connectionString = @"Data Source=DESKTOP-VIVE40H\SQLEXPRESS;Initial Catalog=ClassDatabase;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
            ...
            private void loaddb()
            {
                ...
                {
                //Ask a question
                string QueryString = @"SELECT * FROM Class_Table WHERE name='pranshu';";
        ...
        private void BtnCount_Click(object sender, EventArgs e)
        {
                ...
                string queryString = "SELECT COUNT(ID) FROM Class_Table";
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    SqlCommand Command = new SqlCommand(queryString, connection);
                    connection.Open();
